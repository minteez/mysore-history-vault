...
function Genealogy() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      <p className="eyebrow text-primary">Succession</p>
      <h1 className="mt-3 font-display text-5xl">Wadiyar genealogy</h1>
      <div className="rule-gold mt-4" />
      <p className="mt-6 max-w-2xl text-muted-foreground">
        A summary succession list. Early reigns before the sixteenth century rest largely on
        dynastic tradition; dates thereafter follow the Mysore Gazetteer and standard reference
        works.
      </p>
